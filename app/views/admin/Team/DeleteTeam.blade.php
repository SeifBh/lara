...
<body>
{{ Form::open(['action' => 'TeamController@DeleteTeam_succes','method' => 'POST',  'id' => 'myForm']) }}
                        ...
                        $.get('/Teams?team_id='+team_id,function(data){
                           ...
                           $("input").remove();
                             $("label").remove();
                                    ...
                                    $(".form-group2").append('<input class="btn btn-danger" type="submit" value="Modifier Equipe"/>')
