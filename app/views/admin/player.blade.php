...
{{ Form::open(array('action' => 'AddPlayerController@AddPlayer','method' => 'post')) }}
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a class="active-menu"  href="Player"><i class="fa fa-desktop fa-3x"></i>Gestion des Joueurs</a>
                    </li>
                    <li>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form role="form">
                                        <div class="form-group has-success">
                                            ...
                                            <input name="nom" type="text" class="form-control" id="inputSuccess">
                                        </div>
                                        <div class="form-group has-success">
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <input name="position" type="text" class="form-control" id="inputSuccess">
                                        </div>                                    </br>
